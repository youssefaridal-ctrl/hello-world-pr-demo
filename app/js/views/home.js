...
export function renderHome(container) {
  ...
  const greeting = level >= 10 ? "أنت الآن متحدث متمكن! 🎉" : level >= 5 ? "تقدّمك رائع، واصل!" : "لنبدأ رحلة تعلم الفرنسية!";

  container.innerHTML = `
    <div class="hero-card">
      <h1>${greeting}</h1>
      <p>المستوى ${level} · ${xpIntoLevel}/100 نقطة للمستوى التالي</p>
      <div class="level-progress"><div class="level-progress__bar" style="width:${xpIntoLevel}%"></div></div>
    </div>

    <div class="stats-grid">
      <div class="mini-stat"><div class="mini-stat__value">${state.streak}🔥</div><div class="mini-stat__label">أيام متتالية</div></div>
      <div class="mini-stat"><div class="mini-stat__value">${mastered}</div><div class="mini-stat__label">كلمة متقنة</div></div>
      <div class="mini-stat"><div class="mini-stat__value">${totalWords}</div><div class="mini-stat__label">مجموع الكلمات</div></div>
    </div>
    ...
    <div class="card" id="continue-card" style="cursor:pointer;">
      <div style="display:flex;align-items:center;gap:14px;">
        ...
        <div style="flex:1;">
          <div style="font-weight:700;">${hasProgress ? "أكمل التعلم" : "ابدأ أول درس"}: ${nextCategory.title}</div>
    ...
    <div class="section-heading">
      <h2>تدرّب على المحادثة</h2>
      <a href="#/conversations">الكل</a>
    </div>
    ...
    ${badges.length ? `
      <div class="section-heading"><h2>أوسمتك</h2><a href="#/profile">عرض الكل</a></div>
